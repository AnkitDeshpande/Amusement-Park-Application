...
public class IActivityService implements ActivityService {
	 ...
	 *                 information.
	 * @return Page object containing a list of activities associated with the
	 *         specified park.
	 * @throws ActivityNotFoundException   If no activities are found for the
	 *                                     specified park.
	 * @throws SomethingWentWrongException If an unexpected issue occurs while
	 *                                     fetching activities.
	 */
	@Override
	public Page<Activity> getActivitiesByPark(Integer parkId, Pageable pageable)
	...
	/**
	 * Retrieves a paginated and sorted list of activities related to a particular
	 * park in ascending order.
	 *
	 * @param parkId   ID of the park for which activities are requested.
	 * @param pageable Pageable object containing pagination and sorting
	 *                 information.
	 * @return Page object containing a list of activities related to the specified
	 ...
	 */
	@Override
	public Page<Activity> getActivitiesByParkSortedAsc(Integer parkId, Pageable pageable)
	 ...
	 */
	@Override
	public Page<Activity> getActivitiesByParkSortedDesc(Integer parkId, Pageable pageable)
			throws ParkNotFoundException, SomethingWentWrongException {
		Optional<Park> parkOptional = parkRepository.findById(parkId);
		if (parkOptional.isPresent() && !parkOptional.get().isDeleted()) {
	 ...
	 */
	@Override
	public List<Activity> addActivitiesInBulk(Integer parkId, Set<Activity> activities)
			throws SomethingWentWrongException {
		Park park = parkRepository.findById(parkId)
				.orElseThrow(() -> new SomethingWentWrongException("Park not found!!"));
